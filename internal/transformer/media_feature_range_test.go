...
func TestMediaQueryRanges_Unsupported(t *testing.T) {
	assert.Panics(t, func() { Transform(`@media (200px < width < 600px) {}`) })
	assert.Panics(t, func() { Transform(`@media (width < 600px) {}`) })
	assert.Panics(t, func() { Transform(`@media (200px < width) {}`) })
	assert.Panics(t, func() { Transform(`@media (200px > width > 600px) {}`) })
	assert.Panics(t, func() { Transform(`@media (width > 600px) {}`) })
	assert.Panics(t, func() { Transform(`@media (200px > width) {}`) })
}
